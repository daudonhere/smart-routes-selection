...
export default function Home() {
  ...
  if (isMapLoading) {
    return (
      <div className="flex flex-col items-center justify-center h-screen w-screen text-center background-primary text-text-primary">
        ...
        <p className="text-sm text-text-secondary">Location will be set randomly if GPS not working properly</p>
      </div>
    );
  }
